...
void instructions()
{
		...
		std::cout << "2. Each pit starts out with 4 pieces, and the mancalas(the large pits on either side) start out with 0 pieces. The number in each pit represents how many pieces are in that pit.\n";
		...
		std::cout << "6. On your turn, you type in the name of the pit you want to play (A1, A2, B1, B2, etc.)\n";
		std::cout << "7. The pieces in that pit will then be evenly distributed to the pits counter clockwise from that pit, exculding the other players mancala. \n";
		std::cout << "8. If the last piece on your move lands in your mancala, then you get a free turn,.\n";
		std::cout << "9. If the last piece on your move lands in an empty pit on your side of the board, you \"capture\" that piece and any pieces in the direct opposite pit, and all of those pieces go to your mancala.\n";
		std::cout << "10. The game ends when all six pits on one side of the board are empty.\n";
